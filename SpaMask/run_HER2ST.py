...
def load_adata(section_ids, k_cutoff, rad_cutoff, model, n_top_genes):
    ...
    for section_id in section_ids:
        ...
        # Read data
        path = f'../../../datasets/HER2ST/{section_id}/'
        adata = sc.read_h5ad(path+f'{section_id}.h5ad')
        ...
        n_clusters = len(np.unique(adata.obs['Ground Truth']))-1
    ...
    adata_X = PCA(n_components=100, random_state=42).fit_transform(adata_st.X)
