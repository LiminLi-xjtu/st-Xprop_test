...
def main(args):
    ...
    try:
        clustering(adata, n_clusters, used_obsm=used_obsm, method='leiden', start=0.1, end=2.0,
                   increment=0.01)
    except Exception as e:
        adata.obs['leiden'] = None

    try:
        clustering(adata, n_clusters, used_obsm=used_obsm, method='louvain', start=0.1, end=3.0,
                   increment=0.01)
    except Exception as e:
