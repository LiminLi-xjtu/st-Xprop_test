...
def main(args):
    ...
    ##################################################################################
    result_path = '../output/HER2ST/' + sample_name + '/'
    ...
    file_fold = '../../../datasets/HER2ST/' + str(sample_name)  # please replace 'file_fold' with the download path
    ...
    adata.obsm["X_pca"] = PCA(n_components=100, random_state=0).fit_transform(adata.X)
    ...
    spCLUE_model = spCLUE.spCLUE(adata.obsm["X_pca"], graph_dict, n_clusters, dim_input=100)
