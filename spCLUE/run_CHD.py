...
def main(args):
    ...
    file_fold = '../../datasets/CHD/' + str(sample_name)  # please replace 'file_fold' with the download path
    ...
    adata = sc.read_h5ad(f'{file_fold}/{sample_name}_reset.h5ad')
...
if __name__ == '__main__':
   ...
   parser.add_argument('--slice', type=str, default='D14_measured', help='name of the dataset') #'D14_estimated' 'D14_measured'
