...
def main(args):
    ...
    dir_output = f'./output/{sample_name}/'
    cluster_path = './cluster/' + sample_name + '/'
    ...
    res=spg.search_res(adata, adj, l, n_clusters, start=2.0, step=0.1, tol=5e-3, lr=0.05, max_epochs=20, r_seed=r_seed,
